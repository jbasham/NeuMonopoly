...
public class Utility extends Property
{
	...
	public int getRent(int[] diceRoll, Player player) {
		//This is an overloaded method rather than an overridden one now. On the fly changes ftw!
		int utilitiesOwned = 0;
		int diceTotal = diceRoll[0]+diceRoll[1];
		int total = 0;
		
		//loops through the players properties and increments utilitiesOwned if they own more than 1
		//I realized this could be done more efficiently after I finished it, but for now this works
